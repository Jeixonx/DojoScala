object ScalaWorksheet {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(100); 
  ...
  megaLista.filter{persona => persona(0) == "Juan"};System.out.println("""res4: List[List[String]] = """ + $show(res$4));$skip(82); 
	...
	var list = List.range(1,20);System.out.println("""list  : List[Int] = """ + $show(list ));$skip(92); val res$5 = 
